...
(
  SELECT
    ...
    {{ datediff( 'cast(min(i.interaction_initiation_timestamp) as timestamp)', 'cast(max(i.interaction_end_timestamp) as timestamp)', 'second') }} as session_duration_seconds,
