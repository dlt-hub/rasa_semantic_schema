...
SELECT
  ...
  min(case when e.event = 'user' then e.reply_time_seconds else null end) as answer_time_from_user_seconds,
  min(case when e.event = 'bot' then e.reply_time_seconds else null end) as answer_time_from_bot_seconds,
  min(case when e.event = 'user' then e.next_reply_time_seconds else null end) as answer_time_to_user_seconds,
  min(case when e.event = 'bot' then e.next_reply_time_seconds else null end) as answer_time_to_bot_seconds,
